...
//    self.floatinBall.autoCloseEdge = NO;
    ...
    /*
    [self.floatinBall setBallContent:@"悬浮球哈哈哈" contentType:RASFloatingBallContentTypeText];
    
    UIButton *button = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 60, 60)];
    [button setTitle:@"测试" forState:UIControlStateNormal];
    [button setTitleColor:[UIColor redColor] forState:UIControlStateNormal];
    [self.floatinBall setBallContent:button contentType:RASFloatingBallContentTypeCustomView];
    ...
    [self.floatinBall setBallContent:button1 contentType:RASFloatingBallContentTypeCustomView];
    ...
    [self.floatinBall setBallContent:button3 contentType:RASFloatingBallContentTypeCustomView];
...
- (id)floatingBall:(RASFloatingBall *)floatingBall clickJumpKind:(NSString *)kind {
    return nil;
}
