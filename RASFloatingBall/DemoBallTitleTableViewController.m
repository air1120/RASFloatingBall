...
- (void)viewDidLoad {
    ...
    self.floatingBall = [[RASFloatingBall alloc] initWithFrame:CGRectMake(0, 0, 100, 60)];
    self.floatingBall.backgroundColor = [UIColor lightGrayColor];
    self.floatingBall.clickHandler = ^(RASFloatingBall * _Nonnull floatingBall) {
...
- (void)tick:(CADisplayLink *)link {
    ...
    [self.floatingBall setContent:[NSString stringWithFormat:@"%d FPS", (int)round(fps)] contentType:RASFloatingBallContentTypeText];
